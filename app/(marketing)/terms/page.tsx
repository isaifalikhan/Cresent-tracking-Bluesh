    ...
    <div className="pt-24 bg-background min-h-screen">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="space-y-8 text-muted-foreground text-sm leading-relaxed">
          <section>
            <h2 className="font-display font-semibold text-xl text-foreground mb-3">1. Agreement to Terms</h2>
            <p>
          ...
          <section>
            <h2 className="font-display font-semibold text-xl text-foreground mb-3">2. Services</h2>
            <p>
          ...
          <section>
            <h2 className="font-display font-semibold text-xl text-foreground mb-3">3. Subscription and Payment</h2>
            <p>
          ...
          <section>
            <h2 className="font-display font-semibold text-xl text-foreground mb-3">4. Hardware</h2>
            <p>
          ...
          <section>
            <h2 className="font-display font-semibold text-xl text-foreground mb-3">5. Acceptable Use</h2>
          ...
          <section>
            <h2 className="font-display font-semibold text-xl text-foreground mb-3">6. Service Level Agreement</h2>
            <p>
          ...
          <section>
            <h2 className="font-display font-semibold text-xl text-foreground mb-3">7. Cancellation</h2>
            <p>
          ...
          <section>
            <h2 className="font-display font-semibold text-xl text-foreground mb-3">8. Governing Law</h2>
            <p>
