    ...
    <div className="pt-24 bg-background min-h-screen">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="space-y-8 text-muted-foreground text-sm leading-relaxed">
          <section>
            <h2 className="font-display font-semibold text-xl text-foreground mb-3">1. Information We Collect</h2>
            <p>
          ...
          <section>
            <h2 className="font-display font-semibold text-xl text-foreground mb-3">2. How We Use Your Information</h2>
          ...
          <section>
            <h2 className="font-display font-semibold text-xl text-foreground mb-3">3. Data Security</h2>
            <p>
          ...
          <section>
            <h2 className="font-display font-semibold text-xl text-foreground mb-3">4. Data Sharing</h2>
            <p>
          ...
          <section>
            <h2 className="font-display font-semibold text-xl text-foreground mb-3">5. Data Retention</h2>
            <p>
