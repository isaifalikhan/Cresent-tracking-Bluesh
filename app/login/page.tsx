  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <motion.div 
        ...
        className="w-full max-w-md bg-card/50 border border-border rounded-2xl p-8 backdrop-blur-xl relative z-10 shadow-2xl"
      >
        ...
        {/* Role Toggle */}
        <div className="flex bg-muted/50 p-1 rounded-lg mb-8 border border-border">
          <button
        ...
        <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
          ...
          <div className="space-y-2">
            <div className="flex justify-between">
              ...
              <a href="#" className="text-xs text-blue-600 dark:text-blue-400 hover:text-blue-500 dark:hover:text-blue-300">Forgot password?</a>
            </div>
            <div className="relative">
        ...
        <div className="mt-6 text-center text-xs text-muted-foreground">
          Don't have an account? <a href="#" className="text-blue-600 dark:text-blue-400 hover:text-blue-500 dark:hover:text-blue-300">Contact Sales</a>
        </div>
      </motion.div>
    </div>
  );
