    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-1">Real-time status of your assigned vehicles.</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Map Placeholder */}
        <div className="bg-card border border-border rounded-xl overflow-hidden h-[400px] relative group">
          ...
          <div className="absolute bottom-0 left-0 w-full p-6">
            ...
            <p className="text-muted-foreground text-sm">3 vehicles currently active</p>
          </div>
        ...
        <div className="space-y-4 overflow-y-auto h-[400px] pr-2 custom-scrollbar">
          {myVehicles.map((vehicle, index) => (
            <motion.div
              ...
              className="bg-card border border-border rounded-xl p-5 hover:border-border/80 transition-all group"
            >
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-lg bg-muted flex items-center justify-center text-blue-400 group-hover:text-white group-hover:bg-blue-600 transition-colors shadow-lg group-hover:shadow-blue-900/20">
                    <Truck className="w-6 h-6" />
                  </div>
                  <div>
                    <h3 className="font-semibold text-foreground text-lg">{vehicle.number}</h3>
                    <div className="flex items-center gap-2 text-xs text-muted-foreground">
                      <span className="px-2 py-0.5 bg-muted rounded-full border border-border">{vehicle.type}</span>
                      <span>•</span>
              ...
              <div className="grid grid-cols-2 gap-4 pt-4 border-t border-border">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-foreground truncate max-w-[120px]">{vehicle.location}</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="p-2 bg-muted rounded-lg text-muted-foreground">
